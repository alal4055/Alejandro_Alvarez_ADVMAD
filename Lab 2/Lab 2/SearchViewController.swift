...
//  Lab 2
//
//  Created by Alejandro Alvarez on 2/22/18.
...
class SearchViewController: UITableViewController, UISearchResultsUpdating {
    ...
    func updateSearchResults(for searchController: UISearchController) {
        let searchString = searchController.searchBar.text //search for the string
        filteredWords.removeAll(keepingCapacity: true) //removes things in array
